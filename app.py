...
# ID Único da sua planilha (Extraído da sua Foto 83)
sheet_id = "1jFpKsA1jxOchNS4s6yE5M9YvQz9yM_NgWONjly4il3o"

# Menu lateral com nomes EXATOS
...
try:
    # URL de exportação direta para CSV (Caminho que o Streamlit entende)
    ...
    st.error(f"⚠️ Erro ao carregar a aba '{aba_nome}'.")
